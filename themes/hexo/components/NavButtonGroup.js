/*
 * @Date: 2023-06-05 16:39:41
 * @FilePath: \NotionNext\themes\hexo\components\NavButtonGroup.js
 */
...
const NavButtonGroup = props => {
  ...
  return (
    <nav
      id="home-nav-button"
      className={
        'w-full md:min-h-52 md:mt-6 xl:mt-32 px-5 py-2 mt-8 flex flex-wrap md:max-w-5xl space-y-2 md:space-y-0 md:flex justify-center max-h-80 overflow-auto'
      }
    >
