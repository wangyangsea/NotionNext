...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '胖大海', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '尼古拉斯·码农', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tyoupingping.com', // 网站地址
